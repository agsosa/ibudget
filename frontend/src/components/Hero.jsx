...
const PrimaryButton = tw.button`font-bold px-8 lg:px-10 py-3 rounded bg-primary-500 text-gray-100 hocus:bg-primary-600 focus:shadow-outline focus:outline-none transition duration-300`;
