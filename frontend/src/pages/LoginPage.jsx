...
import illustration from "third-party/treact/images/login-illustration.svg";
import logo from "third-party/treact/images/logo.svg";
import googleIconImageSrc from "third-party/treact/images/google-icon.png";
import twitterIconImageSrc from "third-party/treact/images/twitter-icon.png";
...
export default ({
  ...
  headingText = "Sign in to " + APP_NAME,
  socialButtons = [
    {
