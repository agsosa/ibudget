...
export default () => (
  <Container>
    <Content>
      <MainContainer>
        <MainContent>
          <Heading>{config.headingText}</Heading>
          <FormContainer>
            <SocialButtonsContainer>
              {config.socialButtons.map((socialButton, index) => (
            ...
            <Form>
              ...
              <SubmitButton type="submit">
                <config.SubmitButtonIcon className="icon" />
                <span className="text">{config.submitButtonText}</span>
              </SubmitButton>
